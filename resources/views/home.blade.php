                                                        ...
                                                        <div class="row" style="margin:0px">
                                                            ...
                                                            <div class="col l11">
                                                                <select name="type" id="type">
                                                                    <option value="" disabled selected> Employment
                                                                        Type
                                                                    </option>
                                                                    <option value="{{\App\Constant::job_parttime}}">Part
                                                                        Time
                                                                    </option>
                                                                    <option value="{{\App\Constant::job_fulltime}}">Full
                                                                        Time
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="row" style="margin:0px">
                                                            ...
                                                            <div class="col l11">
                                                                <select name="salary" id="salary">
                                                                    ...
                                                                    <option value="{{\App\Constant::job_notpaid}}">Not Paid
                                                                    </option>
                                                                    <option value="{{\App\Constant::job_paid}}">Paid
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
