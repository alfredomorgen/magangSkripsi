                                ...
                                <ul class="collapsible" data-collapsible="expandable">
                                    <li>
                                        <div class="collapsible-header cyan-text hoverable active"><i
                                                    class="material-icons">contacts</i>Information
                                        </div>
                                        <div class="collapsible-body"><p>
                                                ...
                                                <i class="tiny material-icons">label_outline</i> {{ $user->company->industry }}
                                                <br>
                                                <i class="tiny material-icons">language</i> {{ $user->company->website }}
                                                <br>
                                            </p></div>
                                    </li>
                                    <li>
                                        <div class="collapsible-header cyan-text hoverable active"><i
                                                    class="material-icons">receipt</i>Description
                                        </div>
